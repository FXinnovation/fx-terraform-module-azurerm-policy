...
| path\_to\_policy\_assignment\_parameters | Path to the json file where the policy assignment parameters are defined. The  file is a JSON object that maps to the Parameters field from the Policy Definition. Changing this forces a new resource to be created. | `string` | `""` | no |
