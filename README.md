...
| policy\_assignment\_parameters | List of parameters for the policy definition. This field is a JSON object that maps to the Parameters field from the Policy Definition. Changing this forces a new resource to be created. | `list` | `[]` | no |
...
| policy\_initiative\_definitions | The List which provides policy definitions for the policy set definition. This is a json object representing the bundled policy definitions . | `list` | `[]` | no |
...
| policy\_initiative\_metadatas | A list which describes the metadata for the policy initiatives. This is a json object representing additional metadata that should be stored with the policy definition. | `list` | `[]` | no |
...
| policy\_initiative\_parameters | List of arameters for the policy initiatives. This field is a json object that allows you to parameterize your policy definition. | `list` | `[]` | no |
...
| policy\_metadatas | List of  metadatas for the Policy definition. This is a json object representing additional metadata that should be stored with the policy definition. | `list` | `[]` | no |
...
| policy\_parameters | List of parameters for the Policy definition. This field is a json object that allows you to parameterize your policy definition. | `list` | `[]` | no |
| policy\_rules | List of policy rules for the Policy definition. This is a json object representing the rule that contains an if and a then block. | `list` | `[]` | no |
