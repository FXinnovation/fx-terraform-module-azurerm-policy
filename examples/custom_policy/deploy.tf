...
module "custom" {
  ...
  policy_names              = ["tftest${random_string.this.result}", "foo${random_string.this.result}"]
  policy_types              = ["Custom"]
  policy_modes              = ["All"]
  policy_display_names      = ["terraform_test${random_string.this.result}", "terraform_test${random_string.this.result}"]
