locals {
  ...
  policy_assignment_parameter_files        = split(",", local.policy_definition_parameter_files_string)
...
resource "azurerm_policy_definition" "this" {
  ...
  metadata            = var.path_to_policy_definition_metadatas != "" ? file("${var.path_to_policy_definition_metadatas}/${element(local.policy_definition_metadata_files, count.index)}") : ""
  policy_rule         = var.path_to_policy_definition_rules != "" ? file("${var.path_to_policy_definition_rules}/${element(local.policy_definition_rule_files, count.index)}") : ""
  parameters          = var.path_to_policy_definition_parameters != "" ? file("${var.path_to_policy_definition_parameters}/${element(local.policy_definition_parameter_files, count.index)}") : ""
...
resource "azurerm_policy_assignment" "this_assignment" {
  ...
  policy_definition_id = element(var.policy_names, count.index) != "" ? element(azurerm_policy_definition.this.*.id, count.index) : element(var.policy_assignment_policy_definition_ids, count.index)
  ...
  parameters           = var.path_to_policy_assignment_parameters != "" ? file("${var.path_to_policy_assignment_parameters}/${element(local.policy_assignment_parameter_files, count.index)}") : ""
...
resource "azurerm_policy_set_definition" "this_definition" {
  ...
  policy_definitions  = var.path_to_policy_initiative_policy_definitions != "" ? file("${var.path_to_policy_initiative_policy_definitions}/${element(local.policy_initiative_policy_definition_files, count.index)}") : ""
  ...
  metadata            = var.path_to_policy_initiative_metadatas != "" ? file("${var.path_to_policy_initiative_metadatas}/${element(local.policy_initiative_metadata_files, count.index)}") : ""
  parameters          = var.path_to_policy_initiative_parameters != "" ? file("${var.path_to_policy_initiative_parameters}/${element(local.policy_initiative_parameter_files, count.index)}") : ""
}
